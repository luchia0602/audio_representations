...
def main():
    drive_base_path = "/content/drive/MyDrive/speech_project"
    input_csv = f"{drive_base_path}/data/processed/corpus_parsed.csv"
    output_file = f"{drive_base_path}/data/processed/features_xlsr.npz"

    device = "cuda" if torch.cuda.is_available() else "cpu"
    model_name = "facebook/wav2vec2-large-xlsr-53"
    target_layers = [6, 12, 18] 

    print("Loading XLS-R model and feature extractor...")
